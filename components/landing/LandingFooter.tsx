...
export const LandingFooter: React.FC<LandingFooterProps> = ({ onLoginClick, onGetStartedClick }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">
              Ready to Start Your Ascension?
            </h2>
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of visionaries who are already designing their future.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              The AI-powered platform for designing your future. Transform dreams into actionable plans.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Print Products</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            © 2024 Visionary Inc. All rights reserved. Powered by AI.
          </p>
